...
#finding
time = len(first_input_list) * drill
counter = 0
...
"""
Example
gold,silver,jewels,cheese =>gold => 5
gold,silver,jewels,cheese =>silver=>10
gold,diamonds,documents,Declaration of Independence,keys => Declaration of Independence => 20
"""